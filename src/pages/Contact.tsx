    ...
    <main className="pt-32 pb-24 px-6 relative z-10 min-h-screen">
      <div className="max-w-6xl mx-auto grid md:grid-cols-12 gap-6">
        ...
        <motion.div
          ...
          className="md:col-span-5 bg-primary-600 rounded-[32px] p-10 flex flex-col justify-between text-white relative overflow-hidden"
        >
        ...
        >
          <form className="flex flex-col gap-6 w-full" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-[10px] uppercase tracking-widest text-white/50 font-bold ml-2">Affiliation (Company)</label>
                <input 
                  type="text" 
                  className="w-full bg-space-900/50 border border-white/10 rounded-2xl px-5 py-4 text-white text-sm focus:outline-none focus:border-primary-500/50 focus:bg-primary-900/10 transition-all placeholder:text-white/20"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] uppercase tracking-widest text-white/50 font-bold ml-2">Transmission Link (Email)</label>
              <input 
                type="email" 
                className="w-full bg-space-900/50 border border-white/10 rounded-2xl px-5 py-4 text-white text-sm focus:outline-none focus:border-primary-500/50 focus:bg-primary-900/10 transition-all placeholder:text-white/20"
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[10px] uppercase tracking-widest text-white/50 font-bold ml-2">Mission Parameters (Message)</label>
              <textarea 
                rows={5}
                ...
                placeholder="We need to boost our lead velocity by 30%..."
              />
            </div>
