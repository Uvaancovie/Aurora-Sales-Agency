...
subtitle: >-
  Use AI assistants to interact with your Brevo account using natural language —
...
<Note>Requires [Node.js](https://nodejs.org) installed on your machine.</Note>
...
Alternatively, add this to `~/.claude.json`:
...
| **contact_import_export** | `/v1/brevo_contact_import_export/mcp` | Import and export contacts in bulk |
